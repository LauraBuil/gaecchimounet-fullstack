...
function CircleCommands() {
    return (
        <section className="commands">
            <a href="https://commande.kuupanda.com/producteur/2927/particulier" target="_blank" rel="noopener noreferrer" className="link link--alt">
                <svg viewBox="0 0 200 200" width="200" height="200" xmlns="http://www.w3.org/2000/svg" className="link__svg"
                    ...
                    <title id="link2-title">• Commandez • Du Vendredi au Mardi</title>
                    ...
                    <path id="link-circle-alt" className="link__path" d="M 35, 100 a 65,65 0 1,1 130,0 a 65,65 0 1,1 -130,0"
                          stroke="none" fill="none" />

                    <path className="link__cloud"
                    ...
                    <text className="link__text">
                        {/* Remplacez `href` par `xlinkHref` pour compatibilité JSX */}
                        <textPath className="font-josefin" xlinkHref="#link-circle-alt" stroke="none">
                            • Commandez • Du • Vendredi au Mardi
                        </textPath>
                    </text>
                </svg>
            </a>
